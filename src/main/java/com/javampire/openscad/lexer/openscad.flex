...
COMMENT_CUSTOMIZER_CONTENT=("["[^\]\r\n]+"]")
COMMENT_CUSTOMIZER_VALUE="//"{BLANK}*({COMMENT_CUSTOMIZER_CONTENT} | [0-9.]+){BLANK}*{CRLF}
COMMENT_CUSTOMIZER_TABS=("/*"{BLANK}*{COMMENT_CUSTOMIZER_CONTENT}{BLANK}*"*/"){BLANK}*{CRLF}
