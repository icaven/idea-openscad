...
public class OpenSCADSyntaxHighlighter extends SyntaxHighlighterBase {
    public static final TextAttributesKey SEPARATOR = createTextAttributesKey("OPENSCAD_SEPARATOR", DefaultLanguageHighlighterColors.COMMA);
    public static final TextAttributesKey STRING = createTextAttributesKey("OPENSCAD_STRING", DefaultLanguageHighlighterColors.STRING);
    public static final TextAttributesKey IMPORT_PATH = createTextAttributesKey("OPENSCAD_IMPORT_PATH", STRING);
    public static final TextAttributesKey NUMBER = createTextAttributesKey("OPENSCAD_NUMBER", DefaultLanguageHighlighterColors.NUMBER);
    public static final TextAttributesKey IDENTIFIER = createTextAttributesKey("OPENSCAD_IDENTIFIER", DefaultLanguageHighlighterColors.IDENTIFIER);
    ...
    public static final TextAttributesKey PARENTHESES = createTextAttributesKey("OPENSCAD_PARENTHESES", SEPARATOR);
    public static final TextAttributesKey OPERATION_SIGN = createTextAttributesKey("OPENSCAD_OPERATION_SIGN", SEPARATOR);
    public static final TextAttributesKey COMMENT = createTextAttributesKey("OPENSCAD_COMMENT", DefaultLanguageHighlighterColors.LINE_COMMENT);
    public static final TextAttributesKey CUSTOMIZER_COMMENT = createTextAttributesKey("OPENSCAD_CUSTOMIZER_COMMENT", DefaultLanguageHighlighterColors.DOC_COMMENT);
    public static final TextAttributesKey BAD_CHARACTER = createTextAttributesKey("OPENSCAD_BAD_CHARACTER", HighlighterColors.BAD_CHARACTER);
    public static final TextAttributesKey KEYWORD = createTextAttributesKey("OPENSCAD_KEYWORD", DefaultLanguageHighlighterColors.KEYWORD);
    public static final TextAttributesKey IMPORT = createTextAttributesKey("OPENSCAD_IMPORT", KEYWORD);
    ...
    private static final TextAttributesKey[] CUSTOMIZER_COMMENT_KEYS = new TextAttributesKey[]{CUSTOMIZER_COMMENT};
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (ANGLE_BRACKETS_TOKENS.contains(tokenType)) {
            ...
            return COMMENT_KEYS;
        } else if (CUSTOMIZER_COMMENTS.contains(tokenType)) {
            return CUSTOMIZER_COMMENT_KEYS;
